!(function() {
	...
	var To,
				...
				combine: function(t) {
					return (
						...
						function() {
							...
							return (
								en.remove(e, 'width'), en.remove(t, 'width'), e
							);
						}
					);
				},
		...
		yi = function(e, t, n) {
			...
			return (
				0 < r.length ? bt.set(e, t, r.join(' ')) : bt.remove(e, t), !1
			);
		},
		xi = function(e) {
			return bi(e, 'class');
		...
		Qa = function(o, e, t) {
			var n,
				...
				u = {
					...
					percentages:
						((n = i.width), v(n) && -1 !== n.indexOf('%') && !Na(o))
				},
				a = Xa(t, e, 0, 0, u);
		...
		tc = function(t, e) {
			...
			!0 === e
				? (n = d.getParent(t.selection.getStart(), 'table')) &&
				  ...
				  (f = {
						width:
							l.getStyle(c, 'width') || l.getAttrib(c, 'width'),
						height:
	...
	var ac = {
		...
		sc = function(e, t, n, r, o) {
			var i = fc(n, r);
			return (
				e.dom().addEventListener(t, i, o), { unbind: R(dc, e, t, i, o) }
			);
		},
		dc = function(e, t, n, r) {
	...
	var Nc = function(e, t) {
		...
		Bl = function(e, t) {
			...
			return ((n = r),
			0 === n.length ? S.none() : S.some(n[n.length - 1])).bind(function(
				e
			) {
			...
			if (t.keyCode === Al.TAB) {
				...
				if (e.collapsed) {
					...
					zt.cell(a, u).each(function(e) {
						t.preventDefault(),
							(t.shiftKey ? Pl : kl)(n, u, e, r, o).each(function(
								e
							) {
				...
				: pr(r, t, e).bind(function(e) {
						...
						return 0 < t.length
							? (o(n, t, e.start(), e.finish()),
							  S.some(
									Ll.response(S.some(Ul(r, 0, r, yn(r))), !0)
							  ))
							: S.none();
				  });
		},
		...
		ms = function(n, r) {
			return {
				...
				setClipboardRows: function(e) {
					return (
						(t = r), (n = A(e, le.fromDom)), void t.set(S.from(n))
					);
					var t, n;
				},
