	...
	var paste = (function() {
		...
		var shouldInformUserAboutPlainText = function(
			...
			return (
				...
				$_5peev0ikjkmcwpkv.shouldPlainTextInform(editor)
			);
		};
		...
		var register = function(editor, clipboard, userIsInformedState) {
			editor.addCommand('mceTogglePlainTextPaste', function() {
				$_7rw4pkiijkmcwpks.togglePlainTextPaste(
					editor,
					clipboard,
					userIsInformedState
				);
		...
		function filterStyles(editor, validStyles, node, styleValue) {
			...
			global$3.each(styles, function(value, name) {
				...
				if (
					$_5peev0ikjkmcwpkv.getRetainStyleProps(editor) === 'all' ||
		...
		var filterWordContent = function(editor, content) {
			...
			retainStyleProperties = $_5peev0ikjkmcwpkv.getRetainStyleProps(
				editor
			);
		...
		var preProcess = function(editor, content) {
			return $_5peev0ikjkmcwpkv.shouldUseDefaultFilters(editor)
		...
		var postProcessFilter = function(editor, html, internal, isWordHtml) {
			...
			var postProcessArgs = $_d8ovv8ijjkmcwpku.firePastePostProcess(
				editor,
				tempBody,
				internal,
				isWordHtml
		...
		var filterContent = function(editor, content, internal, isWordHtml) {
			var preProcessArgs = $_d8ovv8ijjkmcwpku.firePastePreProcess(
				editor,
				content,
				internal,
				isWordHtml
		...
		var process = function(editor, html, internal) {
			...
			var content = isWordHtml
				? $_759xt5ivjkmcwplk.preProcess(editor, html)
				: html;
		...
		var smartInsertContent = function(editor, html) {
			global$3.each([linkSelection, insertImage, pasteHtml], function(
				action
			) {
		...
		var pasteHtml$1 = function(editor, html, internalFlag) {
			var internal = internalFlag
				? internalFlag
				: $_93gcj3irjkmcwpld.isMarked(html);
			var args = $_7a37nniujkmcwplh.process(
				editor,
				$_93gcj3irjkmcwpld.unmark(html),
				internal
			);
		...
		var pasteText = function(editor, text) {
			...
			text = $_3nag2qisjkmcwple.convert(
				text,
			...
			if (dataTransfer) {
				...
				if (dataTransfer.types) {
					for (var i = 0; i < dataTransfer.types.length; i++) {
						...
						try {
							items[contentType] = dataTransfer.getData(
								contentType
							);
						} catch (ex) {
							items[contentType] = '';
		...
		var getClipboardContent = function(editor, clipboardEvent) {
			...
			return $_2u5gcyj0jkmcwplv.isMsEdge()
		...
		var registerEventHandlers = function(editor, pasteBin, pasteFormat) {
			...
			function insertClipboardContent(
				...
				if (hasContentType(clipboardContent, 'text/html')) {
					...
					internal = internal
						? internal
						: $_93gcj3irjkmcwpld.isMarked(content);
				...
				isPlainTextHtml =
					internal === false &&
					$_3nag2qisjkmcwple.isPlainText(content);
			...
			editor.on('paste', function(e) {
				...
				var internal = hasContentType(
					clipboardContent,
					$_93gcj3irjkmcwpld.internalHtmlMime()
				);
				...
				if (hasContentType(clipboardContent, 'text/html')) {
					e.preventDefault();
					if (!internal) {
						internal = $_93gcj3irjkmcwpld.isMarked(
		...
		var create = function(editor, lastRngCell, pasteBinDefaultContent) {
			...
			dom.bind(pasteBinElm, 'beforedeactivate focusin focusout', function(
				e
			) {
				e.stopPropagation();
			});
		...
		var hasWorkingClipboardApi = function(clipboardData) {
			return (
				...
				$_2u5gcyj0jkmcwplv.isMsEdge() !== true
			);
		};
		...
		var setup = function(editor, clipboard, draggingInternallyState) {
					...
					if (content_1) {
						...
						global$2.setEditorTimeout(editor, function() {
							editor.undoManager.transact(function() {
								...
								content_1 = $_2u5gcyj0jkmcwplv.trimHtml(
									content_1
								);
			...
			editor.on('dragover dragend', function(e) {
				if (
					$_5peev0ikjkmcwpkv.shouldPasteDataImages(editor) &&
		...
		function removeWebKitStyles(editor, content, internal, isWordHtml) {
			...
			var webKitStylesSetting = $_5peev0ikjkmcwpkv.getWebkitStyles(
				editor
			);
			var webKitStyles;
			if (
				$_5peev0ikjkmcwpkv.shouldRemoveWebKitStyles(editor) === false ||
		...
		global.add('paste', function(editor) {
			if ($_ee0gktiejkmcwpkb.hasProPlugin(editor) === false) {
				...
				var pasteFormat = Cell(
					$_5peev0ikjkmcwpkv.isPasteAsTextEnabled(editor)
						? 'text'
						: 'html'
				);
