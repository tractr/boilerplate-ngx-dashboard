	...
	var fullpage = (function() {
		...
		var open = function(editor, headState) {
			...
			editor.windowManager.open({
				...
				onSubmit: function(e) {
					var headHtml = $_5rofa0c3jkmcwoix.dataToHtml(
						editor,
		...
		var unprotectHtml = function(html) {
			return html.replace(/<!--mce:protected ([\s\S]*?)-->/g, function(
				a,
				m
			) {
				return unescape(m);
		...
		var handleSetContent = function(editor, headState, footState, evt) {
			...
			content = $_7stjxwc9jkmcwoja.protectHtml(
			...
			if (
				evt.source_view &&
				$_7rjdl7c7jkmcwoj4.shouldHideInSourceView(editor)
			) {
				return;
			}
			...
			var currentStyleSheetsMap = {};
			global$1.each(headElm.getElementsByTagName('link'), function(
				stylesheet
			) {
				if (
		...
		var handleGetContent = function(editor, head, foot, evt) {
			if (
				...
				evt.content = $_7stjxwc9jkmcwoja.unprotectHtml(
					global$1.trim(head) +
						'\n' +
