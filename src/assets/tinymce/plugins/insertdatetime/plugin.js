	...
	var insertdatetime = (function() {
		...
		var register = function(editor) {
			editor.addCommand('mceInsertDate', function() {
				$_ct6nm0fijkmcwp78.insertDateTime(
					editor,
					$_eftmuxfhjkmcwp76.getDateFormat(editor)
				);
			});
			editor.addCommand('mceInsertTime', function() {
				$_ct6nm0fijkmcwp78.insertDateTime(
					editor,
					$_eftmuxfhjkmcwp76.getTimeFormat(editor)
				);
			});
		};
			...
			editor.addButton('insertdatetime', {
				...
				onclick: function() {
					...
					$_ct6nm0fijkmcwp78.insertDateTime(
						...
						lastFormat
							? lastFormat
							: $_eftmuxfhjkmcwp76.getDefaultDateTime(editor)
					);
				}
			});
