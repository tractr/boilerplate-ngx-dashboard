	...
	var codesample = (function() {
		...
		var $_7apbbvaajkmcwo93 = {
			open: function(editor) {
				...
				var currentLanguage = $_ehme9lahjkmcwoat.getCurrentLanguage(
					editor
				);
				...
				editor.windowManager.open({
					...
					onSubmit: function(e) {
						$_7llv6ladjkmcwo9b.insertCodeSample(
							editor,
							e.data.language,
							e.data.code
						);
		...
		var register = function(editor) {
			editor.addCommand('codesample', function() {
				...
				if (
					...
					$_45zyxsagjkmcwoas.isCodeSample(node)
				) {
		...
		var setup = function(editor) {
			...
			editor.on('PreProcess', function(e) {
				$('pre[contenteditable=false]', e.node)
					.filter(
						$_45zyxsagjkmcwoas.trimArg(
							$_45zyxsagjkmcwoas.isCodeSample
						)
					)
