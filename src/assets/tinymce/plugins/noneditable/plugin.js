(function() {
	var noneditable = (function() {
			...
			while (i--) {
				content = content.replace(
					...
					replaceMatchWithSpan(
						editor,
						content,
						$_a4wz1bi2jkmcwpjc.getNonEditableClass(editor)
					)
				);
			}
			e.content = content;
		...
		var setup = function(editor) {
			...
			editClass =
				' ' +
				global$1.trim($_a4wz1bi2jkmcwpjc.getEditableClass(editor)) +
				' ';
			nonEditClass =
				' ' +
				global$1.trim($_a4wz1bi2jkmcwpjc.getNonEditableClass(editor)) +
				' ';
			var hasEditClass = hasClass(editClass);
			var hasNonEditClass = hasClass(nonEditClass);
			var nonEditableRegExps = $_a4wz1bi2jkmcwpjc.getNonEditableRegExps(
				editor
			);
