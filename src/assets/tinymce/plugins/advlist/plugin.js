	...
	var advlist = (function() {
		...
		var register = function(editor) {
			editor.addCommand('ApplyUnorderedListStyle', function(ui, value) {
				$_55fky08fjkmcwo2a.applyListFormat(
					editor,
					'UL',
			...
			return function(e) {
				...
				editor.on('NodeChange', function(e) {
					var tableCellIndex = findIndex(
						e.parents,
						$_djj0lo8ijkmcwo2g.isTableCellNode
					);
					var parents =
						tableCellIndex !== -1
					...
					var lists = global$1.grep(
						parents,
						$_djj0lo8ijkmcwo2g.isListNode(editor)
					);
					ctrl.active(
		...
		var updateSelection = function(editor) {
			return function(e) {
				var listStyleType = $_djj0lo8ijkmcwo2g.getSelectedStyleType(
					editor
				);
		...
		var register$1 = function(editor) {
			addControl(
				...
				'InsertOrderedList',
				'OL',
				$_2zo4iv8hjkmcwo2f.getNumberStyles(editor)
			);
			addControl(
				editor,
				'bullist',
				...
				'InsertUnorderedList',
				'UL',
				$_2zo4iv8hjkmcwo2f.getBulletStyles(editor)
			);
		};
