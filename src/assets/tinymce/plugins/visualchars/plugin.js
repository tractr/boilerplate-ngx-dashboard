(function() {
	var visualchars = (function() {
		...
		var isComment = function(element) {
			return (
				type(element) === $_488suct7jkmcwsbz.COMMENT ||
		...
		var wrapCharWithSpan = function(value) {
			return (
				...
				$_dey8tosyjkmcwsas.charMap[value] +
				'">' +
				value +
				'</span>'
			);
		...
		var isMatch = function(n) {
			return (
				$_fswyn1t6jkmcwsby.isText(n) &&
				$_fswyn1t6jkmcwsby.value(n) !== undefined &&
				$_dey8tosyjkmcwsas.regExp.test($_fswyn1t6jkmcwsby.value(n))
			);
		};
		...
		var replaceWithSpans = function(html) {
			return html.replace(
				$_dey8tosyjkmcwsas.regExpGlobal,
				$_2nl12ut8jkmcwsc8.wrapCharWithSpan
			);
		};
		...
		var show = function(editor, rootElm) {
			var node, div;
			var nodeList = $_cwpoydszjkmcwsau.filterDescendants(
				Element$$1.fromDom(rootElm),
				$_cwpoydszjkmcwsau.isMatch
			);
			each(nodeList, function(n) {
				var withSpans = $_cwpoydszjkmcwsau.replaceWithSpans(
					$_fswyn1t6jkmcwsby.value(n)
				);
		...
		var toggle = function(editor) {
			...
			var parentNode = $_cwpoydszjkmcwsau.findParentElm(
